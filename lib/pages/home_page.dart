...
import 'package:users/pages/search_destination_page.dart';
import 'package:users/pages/trips_history_page.dart';
      ...
      if (snap.snapshot.value != null) {
        if ((snap.snapshot.value as Map)["blockStatus"] == "no") {
          ...
          cMethods.displaySnackBar(
              "you are blocked. Contact admin: surajm315760@gmail.com", context);
        }
      } else {
        FirebaseAuth.instance.signOut();
        Navigator.push(
